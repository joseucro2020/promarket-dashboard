...
@section('title', isset($coupon) ? __('locale.Edit Coupon') : __('locale.New Coupon'))
...
<section class="row">
  <div class="col-12">
    <div class="card">
        ...
        <h4 class="mb-0">{{ isset($coupon) ? __('locale.Edit Coupon') : __('locale.New Coupon') }}</h4>
        ...
        <form method="POST" action="{{ isset($coupon) ? route('coupons.update', $coupon) : route('coupons.store') }}">
          ...
          <div class="row">
            <div class="col-md-12 mb-1">
              <label class="form-label" for="user_id">{{ __('locale.Seller PRO') }}</label>
              <select id="user_id" name="user_id" class="form-control" required>
                <option value="">{{ __('locale.Select seller') }}</option>
            ...
            <div class="col-md-12 mb-1">
              <label class="form-label" for="code">{{ __('locale.Coupon Code') }}</label>
          ...
          <div class="row">
            <div class="col-md-6 mb-1">
              <label class="form-label" for="uses">{{ __('locale.Uses per client') }}</label>
            ...
            <div class="col-md-6 mb-1">
              <label class="form-label" for="discount_percentage">{{ __('locale.Discount Percentage') }}</label>
            ...
            <div class="col-md-4 mb-1">
              <label class="form-label" for="first_purchase">{{ __('locale.First Purchase ($ - Amount)') }}</label>
            ...
            <div class="col-md-4 mb-1">
              <label class="form-label" for="common_purchase">{{ __('locale.Common Purchase ($ - Amount)') }}</label>
            ...
            <div class="col-md-4 mb-1">
              <label class="form-label" for="recurrent_purchase">{{ __('locale.Recurrent Purchase (% - Percentage)') }}</label>
          ...
          <div class="row">
            <div class="col-12 d-flex justify-content-end mt-2">
              <a href="{{ route('coupons.index') }}" class="btn btn-outline-secondary mr-2">{{ __('locale.Back') }}</a>
              <button type="submit" class="btn btn-primary">{{ isset($coupon) ? __('locale.Update') : __('locale.Save') }}</button>
            </div>
