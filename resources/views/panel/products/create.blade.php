                    ...
                    <div class="row mt-2">
                        <div class="col-md-12 text-center mb-2">
                            ...
                            <div class="demo-inline-spacing justify-content-center">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="typeSimple" name="type" class="custom-control-input" value="simple" checked>
                                    <label class="custom-control-label" for="typeSimple">{{ __('Simple Product') }}</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="typeVariable" name="type" class="custom-control-input" value="variable">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch custom-switch-success">
                                    <input type="checkbox" class="custom-control-input" id="is_pro" name="is_pro">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="min_stock_deactivate" value="5">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('Max Stock to Activate') }}</label>
                                <input type="number" class="form-control" name="max_stock_activate" value="10">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="is_active_hours" name="is_active_hours">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" name="price_1" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="retail" value="1">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ __('Max Sale') }}</label>
                                <input type="number" class="form-control" name="wholesale" value="1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ __('Cost') }}</label>
                                <input type="number" step="0.01" class="form-control" name="price_2" required>
                            </div>
                        </div>
