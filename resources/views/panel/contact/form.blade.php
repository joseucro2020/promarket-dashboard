...
@section('content')
  <section>
    <h2 class="text-center font-italic mb-3">{{ __('Contact Information') }}</h2>
          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('contact.update', $social->id) }}">
              ...
              <div class="d-flex justify-content-between mt-2">
                <a href="{{ route('contact.index') }}" class="btn btn-outline-secondary">{{ __('Back') }}</a>
