...
@section('content')
  <section>
    <h2 class="text-center aboutus-title mb-3">{{ __('About Us') }}</h2>
          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ $us ? route('about-us.update', $us->id) : route('about-us.store') }}">
              ...
              <div class="aboutus-section">
                <div class="row">
                  <div class="col-md-6">
                    <div class="aboutus-heading">{{ __('Who are we? (Spanish)') }}</div>
                  ...
                  <div class="col-md-6">
                    <div class="aboutus-heading">{{ __('Who are we? (English)') }}</div>
              ...
              <div class="aboutus-section">
                <div class="row">
                  <div class="col-md-6">
                    <div class="aboutus-heading">{{ __('Mission (Spanish)') }}</div>
                  ...
                  <div class="col-md-6">
                    <div class="aboutus-heading">{{ __('Mission (English)') }}</div>
              ...
              <div class="aboutus-section">
                <div class="row">
                  <div class="col-md-6">
                    <div class="aboutus-heading">{{ __('Vision (Spanish)') }}</div>
                  ...
                  <div class="col-md-6">
                    <div class="aboutus-heading">{{ __('Vision (English)') }}</div>
