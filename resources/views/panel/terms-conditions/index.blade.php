      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">{{ __('Purchase Terms & Conditions') }}</h4>
          </div>
          <div class="card-body">
            @if(session('success'))
            ...
            <form method="POST" action="{{ route('terms-conditions.store') }}">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>{{ __('Terms and conditions (Spanish)') }}</label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>{{ __('Terms and conditions (English)') }}</label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>{{ __('Purchase conditions (Spanish)') }}</label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>{{ __('Purchase conditions (English)') }}</label>
