  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header border-bottom p-1 d-flex justify-content-between align-items-center">
        <h4 class="mb-0">{{ __('View Category') }}</h4>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-6 mb-1">
            <label class="form-label">{{ __('Category (Spanish)') }}</label>
            <input class="form-control" value="{{ $category->name }}" disabled>
          </div>
          <div class="col-md-6 mb-1">
            <label class="form-label">{{ __('Category (English)') }}</label>
        ...
        <div class="row">
          <div class="col-md-3 mb-1">
            ...
            <input class="form-control" value="{{ $category->status === '1' ? __('Active') : __('Inactive') }}" disabled>
          </div>
        </div>
      </div>
    </div>
