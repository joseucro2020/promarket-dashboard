...
// Silencia advertencias de dependencias (ej. uso de `/` para división en Bootstrap)
// Requiere una versión de `sass` que soporte `quietDeps` (>=1.43). Evita mensajes repetidos.
