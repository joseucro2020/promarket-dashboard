...
Route::group(['prefix' => 'panel'], function () {
  ...
  Route::post('products/indicators', [ProductController::class, 'indicators'])->name('products.indicators');
  ...
  Route::get('clientes/all', [App\Http\Controllers\ClientController::class, 'getAllServer'])->name('clients.getAll');
  ...
  Route::get('clientes/{id}/pedidos', [App\Http\Controllers\ClientController::class, 'getOrders'])->name('clients.orders');
  ...
  Route::match(['GET', 'POST'], 'banners/probe-write-txt', [BannerController::class, 'probeWriteTxt'])->name('banners.probe-write-txt');
